<header class="main-header">
    ...
    <a href="#" class="logo">
        @if (setting('general.admin_theme', 'skin-green-light') == 'skin-green-light')
            ...
            <span class="logo-lg"><img src="{{ asset('public/img/akaunting-logo-white.png') }}" class="logo-image-lg" width="25" alt="Akaunting Logo"> <b>Autheman Tech</b></span>
        @else
            <!-- mini logo for sidebar mini 50x50 pixels -->
            ...
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{ asset('public/img/akaunting-logo-green.png') }}" class="logo-image-lg" width="25" alt="Akaunting Logo"> <b>Autheman Tech</b></span>
        @endif
    </a>
